...
exports.addrole = async (req, res) => {
  ...
  const {seller,store,employee,customer,supplier,product,stockControl,offers,coupons,subscription,billing,order,purcahse,reports,notification,rolesPermission,setting}
